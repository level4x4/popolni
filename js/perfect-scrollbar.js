      ...
      function bindTouchHandler(supportsTouch, supportsIePointer) {
        ...
        function touchMove(e) {
          ...
          if (!inGlobalTouch && inLocalTouch && shouldHandle(e)) {
            ...
            if (Math.abs(differenceY) > 10 && (window.sniff.browserType === 'msie' && window.sniff.browserVersionExtended === "rv")) {
              $this.addClass('ps-touch-move');

              if($this.find('.ps-touch-move-iefix').length === 0) {
                $this.append('<div class="ps-touch-move-iefix"></div>');
              }

              $this.find('.ps-touch-move-iefix').css('top', $this.scrollTop());
            }
        ...
        function touchEnd(e) {
          ...
          if (!inGlobalTouch && inLocalTouch) {
            ...
            $this.removeClass('ps-touch-down ps-touch-move');
            $this.find('.ps-touch-move-iefix').remove();
